...
```log
ok  	github.com/gridchain/gridiron/v9/tests/e2e	174.137s.
```
...
```log
            	Error:      	Received unexpected error:
            	            	...
            	            	main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc0011314e0}, {0x33a2920, 0xc000ed2b80}, 0xc0000155f0}}, {0x3394520, 0xc001633bc0}, {0x33a5cc0, ...}, ...)
            	            		github.com/gridchain/gridiron/v10/cmd/gridirond/root.go:243 +0x2ca
            	            	github.com/gridchain/ethermint/server.startInProcess(_, {{0x0, 0x0, 0x0}, {0x33b7490, 0xc001784c30}, 0x0, {0x7fff50b37f3d, 0xc}, {0x33ac0f8, ...}, ...}, ...)
            	            		github.com/gridchain/ethermint@v0.20.0-rc2/server/start.go:304 +0x9c5
            	            	github.com/gridchain/ethermint/server.StartCmd.func2(0xc001620600?, {0xc001745bd0?, 0x0?, 0x1?})
            	            		github.com/gridchain/ethermint@v0.20.0-rc2/server/start.go:123 +0x1ec
            	            	...
            	            	main.main()
            	            		github.com/gridchain/gridiron/v10/cmd/gridirond/main.go:20 +0x45
